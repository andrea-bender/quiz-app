...
function loadLanding() {
  $('.main').html(
    ...
    <h2>Test your knowledge on the TV show It's Always Sunny in Philidelphia!</h3>
      ...
      <form id='resultForm' class='resultForm'>
        <fieldset>
          <legend class="questionText">
            ...
            ${STORE.questions[STORE.questionNumber].correctAnswer}.</p>
            ${appendImage()}
            <button class= "answerButton" type="submit">Next</button>
          </legend>
        </fieldset>
...
function appendImage() {
  let key = STORE.questions[STORE.questionNumber].correctAnswer;
  return `
...
function generateFinalResultsHtml() {
  ...
  if (score >= 6) {
    ...
    grade = 'Have you ever watched the show?!';
    imgSrc = 'images/noob.jpg';
  } 
  return `
  <div aria-live= "polite" class="formContainer">
